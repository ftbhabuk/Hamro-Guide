...
} from "@/app/create-trip/constants"; // Adjust path based on where your constants are
...
// TravelDatesSelection Component
  ...
  return (
    <div className="space-y-4">
      <div className="space-y-1">
        <TooltipWrapper content="Let us know when you plan to travel for seasonal suggestions.">
